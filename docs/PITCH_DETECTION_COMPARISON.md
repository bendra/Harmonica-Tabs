...
4. Test against real recorded G harmonica samples, not only synthesized sine waves.
5. Compare the same real sample through `tuner` and `harmonica-tabs` frame by frame.
